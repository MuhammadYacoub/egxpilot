...
// 🔍 stockAnalyzer_advanced.js – النسخة الأذكى مع نقاط مخصصة وتحليل احترافي
...
async function analyzeStock(symbol) {
  ...
  // 🔍 تحليل إضافي (مؤشرات مستقبلية)
  const candleSignal = "نمط مطرقة صاعدة"; // placeholder
  ...
  if (candleSignal.includes("مطرقة") || candleSignal.includes("ابتلاع")) score += 10;
...
تظهر تقاطع ${emaCross}، وزخم ${momentumSignal} مع إشارات شموع مثل ${candleSignal}.
